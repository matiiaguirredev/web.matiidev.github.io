new TypeIt('.animated-text', {
    ...
    .type("Hi!👋 I'm Matias Aguirre, Full-Stack Developer.", { delay: 500 })
    .move(1, { delay: 500 })
    .delete(70, { pause: 500 })
    ...
    .type("Welcome</em>", { delay: 750 })
    .move(null, { delay: 500, to: 'end', instant: true })
    .go();

new TypeIt("#simpleUsage", {
    strings: "“And here below, a little bit of my life ...”",
    speed: 50,
